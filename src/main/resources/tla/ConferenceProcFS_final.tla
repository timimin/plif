...
f_get_paper_load(id) == 
 IF XLocks = Undef 
    ...
    /\ New2Old'  = <<
                   <<f_gp_p_p_id (id).policy, f_gp_v_v_paper(id).policy, 
                     f_gp_r_rec_c1(id).policy, 
                     f_gp_r_rec_c2(id).policy,  
                     f_gp_r_rec_c3(id).policy,
                     f_gp_r_rec_c4(id).policy,
...
f_get_paper8(id) == 
    /\ return(id, <<f_gp_r_rec_c1(id).policy, 
                    f_gp_r_rec_c2(id).policy,  
                    f_gp_r_rec_c3(id).policy,
                    f_gp_r_rec_c4(id).policy,
                    f_gp_r_rec_c5(id).policy>>, 
...
f_get_paper(id,st)  ==
    ...
    [] Head(st).pc[2]   = "lbl_9" -> f_get_paper8(id)
